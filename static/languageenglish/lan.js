var lan = {
  get: function (key, args) {
    var msgs = {
      diskinfo_span_1:
        "Available space on disk partition [{1}] is less than 1GB, it may make MySQL service automatically stop, or Panel not accessible, please clean it！",
      process_kill_confirm:
        "Ending task progress name [{1}],PID [{2}] may affect server service, continue?",
      del: "Delete [{1}]",
      del_all_task:
        "Totally selected [{1}] task, it is unable to restore after deleted, continue?",
      ...
      update_num:
        "Only {1} file(s) can be selected at a time, and the rest are not processed!",
      ...
      recycle_bin_confirm:
        "Are you sure to put this file [{1}] to recycle bin?",
      recycle_bin_confirm_dir:
        "Are you sure to put this directory [{1}] to recycle bin?",
      del_all_ftp:
        "Totally selected [{1}] FTP, and it is unable to restore after deleted, continue?",
      del_all_ftp_ok: "Successfully deleted {1} FTP account(s)",
      del_all_database:
        "Totally selected [{1}] database(s), and it is unable to restore after deleted, continue?",
      del_all_database_ok: "Successfully deleted [{1}] database!",
      config_edit_ps:
        "This is {1} primary configuration file, Do not edit it at will if you do not know config rules.",
      install_confirm: "Are you sure to install {1}-{2}?",
      del_all_site:
        "Totally selected [{1}] site,it is unable to recover after delete, continue?",
      del_all_site_ok: "Successfully deleted [{1}] site(s)!",
      ssl_enable:
        'You have enabled [{1}] certificate. To disable it, please click"Disable SSL"button',
  ...
  index: {
    ...
    mem_warning:
      "Currently available physical RAM is less than 64M, which may cause MySQL to automatically stop, site 502 and other errors, please try to free the memory!",
    user_warning:
      "Current panel user is admin, which may bring risks to the panel!！",
    cpu_core: "Core(s)",
    ...
    net_doup_ip_msg:
      "This IP cannot visit server after block, you can unblock this IP in [Security], continue?",
    ...
    rep_panel_ok:
      "Repair completed, please press Ctrl+F5 to refresh the cache!",
    ...
    mem_release_warn:
      "If your site is in a state of heavy access, freeing up RAM can have unpredictable consequences. Are you sure you want to free RAM now?",
    update: "Update",
    ...
    safe_problem_cant_ignore:
      "This security issue cannot be ignored, please handle it ASAP.",
    ...
    change_final_click:
      "If you need to switch back to the stable version, please click",
    ...
    change_test_to_final:
      "Are you sure to switch from the beta to the stable version? ",
    ...
    check_test_version_detail:
      "Please read Instructions for Beta Testers carefully. Are you sure to update to Linux Beta version?",
    ...
    change_free:
      "Switching back to the free version can be achieved by unbinding the account",
    ...
    panel_port_tip1:
      "This security issue cannot be ignored, please handle it as soon as possible.",
  ...
  config: {
    ...
    close_panel_msg:
      "Disabling Panel will make the panel not accessible, are you sure to disable panel service? ",
    ...
    binding_un: "unbind",
    ssl_close_msg:
      "You will have to use http protocol to access the panel after turning off SSL, continue?",
    ...
    ssl_open_ps_2:
      "If you choose to self-certificate browser will show no trust",
    ssl_open_ps_3:
      "If panel is not accessible, you can click the link below to find solutions",
    ssl_open_ps_4:
      "I already know the details, and I'm willing to take the risk.",
    ssl_open_ps_5: "Check details",
    ssl_title: "Set Panel SSL",
    ssl_ps: "Please identify the risk first!",
    ssl_msg:
      "Installing and setting up the SSL component, which will take a few minutes...",
    qrcode_no_list:
      "The current binding list is empty. Please bind and try again",
    confirm: "OK",
    ...
    scan_qrcore_with_small_app:
      "Use aaPanel Mobile to scan the current QR code to bind the panel",
    ...
    help1:
      "When API is enabled, only IP in the IP whitelist can access the panel API.",
    help2:
      "API key is displayed only once when reset and is no longer displayed after that. &nbsp;&nbsp; &nbsp; Please take good care of your key.",
    help3: "The API document",
    is_submitting: "Submitting...",
    create_int_key_success:
      "API key generated. Please keep your new key. This key is only displayed once!",
    ...
    basic_auth_tips1:
      "Note: Please do not use your usual password here, which may lead to password leakage!",
    basic_auth_tips2:
  ...
  crontab: {
    ...
    TZZ7: "Sunday",
    mem_ps:
      "Free RAM of PHP/MySQL/Pure-FTPd/Apache/Nginx, recommended to be executed every midnight!",
    mem: "Free RAM",
    ...
    crontab_stop_will:
      "The cron job will not continue to run after suspended. Are you sure to suspend this cron job?",
    disable_change_crontab_start:
      "The cron job deactivated, are you sure to enable this cron job?",
    setting_status: "Setting status, please wait...",
    exclusion_rule: "Exclusion rule",
    exclusion_rule_tips:
      "For each rule in a row, the directory cannot end with /, e.g.",
  },
  firewall: {
    empty: "Cleaned!",
    port: "Port",
    ...
    ssh_port_msg:
      "Changing the SSH remote port will log out all logged in users, are you sure to change the port?",
    ssh_port_title: "SSH Remote Port",
    ssh_off_msg:
      "Turning off SSH service will also log out all logged in users, continue?",
    ssh_on_msg: "Are you sure to turn on SSH service？",
    ping_msg:
      "Blocking ICMP will NOT affect site access, but ICMP function cannot be used for this server, are you sure to block ICMP？",
    ping_un_msg:
      "The server may be found by hacker after unblocking ICMP, are you sure to unblock ICMP?",
  ...
  upload: {
    ...
    up_err: " Upload ERROR",
    ie_err:
      "Sorry, IE 6/7/8 is NOT supported, please upload files with another browser",
  },
  bt: {
    empty: "empty",
    ...
    edit_ps:
      "Tips：Ctrl+F Search keyword，Ctrl+G Find next，Ctrl+S Save，Ctrl+Shift+R Find & Replace!",
    stop: "Stop",
    start: "Start",
    restart: "Restart",
    reload: "Reload",
    ...
    install_ps:
      "Recommended to use the following one-click packages, please choose on demand or in",
    ...
    install_rpm: "Fast",
    install_rpm_title:
      "i.e. rpm, installed in a very short time (5~10 minutes), with performance and stability a bit lower than compiled",
    install_src: "Compiled",
    install_src_title:
      "installed in a long time (30 minutes to 3 hours), suitable for production environment",
    ...
    insatll_mem:
      "Your RAM is less than {1}, NOT recommended to install MySQL-{2}",
    ...
    panel_ps: "Notes",
    panel_ps_1:
      "Keep info of other server panels to enable one-click login feature",
    panel_ps_2: "Notes of Panel cannot be repeated",
    panel_ps_3:
      "<font style='color:red'>Note that turning on ad blocking will break quick login.</font>",
    task_time: "Time",
    task_name: "Name",
  ...
  files: {
    ...
    recycle_bin_warning:
      "The recycle bin is currently not opened, and it cannot be restored after deletion. Do you want to continue",
    del_in_bulk: "Delete in bulk",
    del_to_recycle_bin:
      "After deleting, it will be moved to the recycle bin. Do you want to continue?",
    mounted_disk: "Mounted disk",
    file_has_been_shared: "File has been shared, click to view information",
    file_has_been_favorite:
      "The file has been added to favorites, click again to cancel",
    ...
    getting_s_share_info:
      "Getting specified sharing information, please wait...",
    ...
    check_same_name_file:
      "Checking if the file with the same name exists, please wait...",
    ...
    recycle_bin_ps:
      "Warning: Removed files cannot be restored if recycle bin feature is turned off!",
    ...
    recycle_bin_re_msg:
      "File or directory with the same name will be overwritten, continue?",
    ...
    recycle_bin_close_msg:
      "Empty recycle bin will permanently delete the files, continue?",
    ...
    zip_ok:
      "Compressing file in server background, please refresh file list to check process later!",
    ...
    mv_ok: "Cut",
    shell_title:
      "Execute Command (only non-interactive commands are supported)",
    shell_go: "Send",
    ...
    upload_files_tips1:
      "PS: aaPanel file upload temporary file, re-upload resume from breakpoint, can be deleted",
  ...
  ftp: {
    ...
    add_path_title:
      "Document root of user, which will automatically create directory of the same name",
  ...
  database: {
    ...
    input_ps2:
      "Structure of zip, tar.gz archive: test.sql must be contained in test.zip or test.tar.gz",
    input_ps3:
      "If the file is oversized, you can also upload database archives to /www/backup/database with SFTP tools",
    ...
    row_num: "Row number",
    tb_repair:
      "[Repair] Try to repair the damaged table with the REPAIR command. You can only do a simple repair. <br>&nbsp;&nbsp; &nbsp; If the repair is not successful, consider using the myisamchk tool.",
    tb_optimization:
      "[Optimize] Execute OPTIMIZE command to recover unreleased disk space. Recommended executing it once a month.",
    tb_change_engine:
      "[Convert to InnoDB/MyISAM] Convert database table engine. Recommended converting all tables to InnoDB",
    repair: "Repair",
  ...
  soft: {
    ...
    reload: "Reload",
    mysql_mem_err:
      "Server RAM is less than 1G. It is not recommended to use MySQL 5.5 or later.</li><li>If the database stops automatically, try to increase swap with Linux Toolbox or increase server memory",
    ...
    php_fpm_ps3:
      "Initial processes (Num of initiatial processes when server starts)",
    php_fpm_ps4:
      "Min idle processes (Kept progress after killing idle processes)",
    php_fpm_ps5:
      "Max idle processes (Kill idle processes when this value is reached)",
    ...
    mvc_ps:
      "Programs with MVC architectural pattern requires it enabled, e.g. typecho",
    ...
    setup: "Setting",
    apache22:
      "Warning: current mode is php-fpm, it is NOT supported by Apache 2.2, please reinstall this PHP version!",
    apache24:
      "Warning: current mode is php5_module, it is NOT supported by Nginx/Apache 2.4, please reinstall this PHP version!",
    apache22_err:
      "Apache 2.2 does NOT support multiPHP, please uninstall installed PHP versions, then install this version!",
    mysql_f:
      "Warning: installing new MySQL version will overwrite data, please backup your databases first!",
    mysql_d:
      "Sorry, for security reason, please go to [Database Manager] to backup and delete all databases!",
    fun_ps1: "Add function to be disabled, e.g. exec",
    fun_ps2:
      "Function can be disabled here to enhance security of environment!",
    fun_ps3:
      "Strongly recommend to disable critical functions such as exec, system!",
    ...
    waf_not:
      "Current Nginx version does NOT support WAF module, please install Nginx 1.12, you will NOT lose any site configuration after reinstalling Nginx!",
    waf_edit: "Edit rules",
    ...
    waf_cc_err:
      "CC defense configuration value exceeds the available value (range of frequency 1-3000|period 1-1800)",
    ...
    log: "Logs",
    mysql_to_msg:
      "MySQL service will stop while moving files of databases, continue?",
    ...
    mysql_port_title:
      "Changing database port may make your site lose database connection, are you sure to continue?",
    ...
    mysql_set_err:
      "ERROR, RAM allocation is too high!<p style='color:red;'>Physical memory: {1}MB<br> Maximum memory: {2}MB<br>Possible result: mysqld service unstable, even unable to start!</p>",
    ...
    mysql_status_ps11:
      "If too high, consider increase your database performance",
    ...
    ap2_2_not_support:
      "Apache 2.2 is NOT compatible with this version, please switch to Apache y2.4 or Nginx if you need to use it.",
    ...
    php_plug_tips1:
      "Pls install the extension according to the actual demand, do NOT install unnecessary PHP extension, this will affect the efficiency of PHP execution, and may even cause an exception",
    php_plug_tips2:
    ...
    php_child_process:
      "The current server is out of memory, up to [{1}] child processes are allowed!",
    del: "Del",
    ...
    save: "Save",
    php_seesion_tips1:
      "If your site has high concurrency, using Redis or Memcache can improve PHP concurrency",
    php_seesion_tips2:
      "If the site access is abnormal after switching the session mode, switch back to the original mode",
    php_seesion_tips3:
      "Switching session mode will cause online user sessions to be lost. Please switch when traffic is low",
    ...
    only_files_storage_mode_can_clear:
      "Only need to clear when the storage mode is files",
    ...
    instantaneous_ops_per_sec:
      "The number of commands executed per second by the server",
    ...
    author: "Author",
    source: "Source",
    third_party_apps_tips1:
      "This is a plugin developed by a third party, aaPanel can not verify its reliability!",
    third_party_apps_tips2:
      "The installation process may take a few minutes, please be patient!",
    third_party_apps_tips3:
      "If this plugin already exists, it will be replaced!",
    cancel: "Cancel",
  ...
  site: {
    ...
    ftp_help:
      "While creating the site, create a corresponding FTP user for the site, and the FTP directory points to the directory where the site is located.",
    database_help:
      "While creating the site, create a corresponding database for the site to facilitate different databases using different databases.",
    domain_help:
      "A domain per line, the default port is 80<br>Wildcard domain format: *.domain.com<br>To add another port, the format is www.domain.com:88",
    ...
    site_help_1:
      "Some programs need to specify a secondary directory as the working directory, e.g., ThinkPHP5, Laravel",
    site_help_2: "Select working directory, and save",
    default_doc_help: "Default indexes, one per line, priority top-to-bottom.",
    site_stop_txt:
      "Unable to access when you turn off site, are you sure to continue?",
    site_start_txt: "About to turn on this site, are you sure to continue?",
    site_del_info:
      "Whether to delete corresponding FTP, database and document root",
    ...
    default_site_help_1:
      "Unbound domains and IP will be redirected to the this website when is set",
    ...
    site_xss_attack:
      "Site did NOT enabled Anti-XSS attack (Base directory limit)!",
    ...
    url_rewrite_alter:
      "Are you sure to create a independent URL rewrite rule for this subdirectory?",
    rule_cov_tool: "Rewrite rule converter",
    a_c_n: "Apache to Nginx",
    save_as_template: "Save as template",
    url_rw_help_1:
      "Please select your application. If the site cannot be accessed as expected with the rewrite rules set, please try to reset to default",
    url_rw_help_2:
    ...
    proxy_help_1:
      "The target URL must be accessible, otherwise it will return 502 error code directly.",
    proxy_help_2:
      "By default all domains on this site will be passed to the target server, please ensure that the target server has a domain name bound",
    proxy_help_3:
      "If your site is a passive proxy, please fill in the domain of the target site in the domain sent.",
    proxy_help_4:
      "If you do not need content replacing feature, please leave blank",
    proxy_help_5:
      "You can clear the cache by purge, e.g., http://test.com/purge/test.png",
    ...
    to301_help_1:
      "If choose entire site, please do NOT set the target URL to the domain in the same site.",
    to301_help_2:
      "After cancelling the 301 redirect, you need to clear your browser cache to see the results",
    bt_ssl: "aaPanel SSL",
    ...
    ssl_help_1:
      "SSL for this site not set, if you need, please switch tab to apply for SSL certificate.<br><p style='color:red;'>After disabling SSL, make sure to clear your browser cache before accessing the site.</p>",
    ssl_help_2: "Automatically generated Let's Encrypt free certificate；",
    ssl_help_3:
      "If you have your own SSL, please switch to [other certificate] tab to add",
    ssl_key: "Private key (KEY)",
    ssl_crt: "Certificate (CRT/PEM)",
    ssl_close: "Disable SSL",
    bt_bind_no:
      "Not bound to aaPanel account, please register and bind. After binding aaPanel account (non-forum account), you can deploy SSL with one click",
    bt_user: "aaPanel Account",
    bt_user_first: "Account",
    login: "Login",
    bt_reg: "Register aaPanel account",
    bt_ssl_help_1:
      "aaPanel SSL certificate is issued by TrustAsia, requires real name identification",
    bt_ssl_help_2: "If you have aaPanel account, please log in and bind it",
    bt_ssl_help_3:
      "aaPanel SSL applys certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, but free for aaPanel users!",
    bt_ssl_help_4: "Free reissue after one year of maturity.",
    btapply: "Apply",
    endtime: "Expired date",
    status: "Status",
    bt_ssl_help_5:
      "Please check domain resolution before applying, unresolved domain leads to audit failure.",
    bt_ssl_help_6:
      "aaPanel SSL certificate is the free version of TrustAsia DV SSL CA - G5 certificate, which only supports a single domain.",
    bt_ssl_help_7:
      "Valid for 1 year, renewal is not supported, reapplication is required after expiration.",
    bt_ssl_help_8:
      "Let's Encrypt free certificate, valid for 3 months, supports wildcard domain. Auto-renew by default.",
    bt_ssl_help_9:
      "If your site uses CDN or 301 redirect, you will not be able to apply for and renew certificate through file verification.",
    bt_ssl_help_10:
      "Paste you KEY and CRT content, and then save it<a href='http://www.bt.cn/bbs/thread-704-1-1.html' class='btlink' target='_blank'>[HELP]</a>。",
    ...
    lets_help_1:
      "No real-name authentication, browser compatibility is slightly lower, and may fail when applied",
    ...
    err_type: "Error type",
    ssl_close_info:
      "SSL disabled, please visit the site after cleaning browser data!",
    switch: "Switch",
    switch_php_help1:
    ...
    nodejs_help3:
      "If your Node.js application has php script, please add .php extension when you access.",
    a_n_n: "Apache 2.2 does NOT support Tomcat!",
    enable_tomcat: "Enable Tomcat",
    tomcat_help1: "Current version is Tomcat ",
    tomcat_help2:
      "If you need other version, please change it in Software Store - All Softwares;",
    tomcat_help3:
      "Deployment order: Install Tomcat >> Create site >> Upload and configure project >> Enable Tomcat",
    tomcat_help4:
      "If your Tomcat application has php script, please add .php extension when you access.",
    tomcat_help5:
      "When successfully enabled, it takes about 1-5 minutes to take effect!",
    tomcat_err_msg:
      "You do NOT have Tomcat installed, please install it first!",
    ...
    firewalld_nonactivated_tips:
      "{1} WAF is not activated yet.<br>Please go to&quot;<a href='/soft' class='btlink'>APP Store > Professional > {2} WAF</a>&quot;<br>to activate and install it.",
    ...
    default_classification_cant_operation:
      "Default category cannot be deleted/edited!",
    ...
    edit_rewrite:
      "You are able to modify rewrite rules, just save it after modification.",
    specify_subdir:
      "Some programs need to specify a secondary directory as the working directory,<br>&nbsp; &nbsp; &nbsp;e.g, ThinkPHP5, Laravel', 'Select your working directory, click Save",
    independent_storage:
      "If trun on, the session file will be stored in a separate folder, not shared with other sites.",
    ...
    video: "Video",
    not_resolve_domain:
      "You applied for a certificate for the domain [{1}], but the program detected that you did not bind and resolve its root domain [{2}] to the site, which would cause the certificate failed to be issued!",
    ssl_tips1:
      "Before applying, please make sure the domain name has been resolved. If it is not resolved, the audit will fail (including the root domain).",
    ssl_tips2:
      "aaPanel SSL applys for the free version of TrustAsia DV SSL CA - G5 certificate, which only supports single domain name application.",
    ssl_tips3:
      "Valid for 1 year, renewal is not supported, reapplication is required after expiration",
    ssl_tips4:
      "It is recommended to use a domain name with a secondary domain name of www to apply for a certificate, so that the system will give away the top-level domain name as an optional name by default",
    ssl_tips5:
      "When you do not specify a SSL default site, if you use HTTPS to access a site that does not have SSL enabled, you will directly access a site that has SSL enabled",
    ssl_tips6:
      "99% of users can easily deploy themselves, if you don't understand, <a class='btlink' href='https://www.bt.cn/yunwei' target='_blank'>aaPanel provides certificate deployment service 50 yuan Once</a>",
    checking_mode: "Verification mode",
    file_check: "File verification",
    dns_check_tips1:
      "In DNS validation, we provide three automated DNS API, and provide manual mode",
    dns_check_tips2:
      "The certificate can be renewed automatically by using the DNS API. In manual mode, the certificate needs to be reapplied after the certificate expires",
    dns_check_tips3:
      "Before using the [aaPanel DNS Cloud Resolution] API, you need to confirm that the domain DNS for which you want to apply for SSL certificate is [Cloud Resolution]",
    dns_check_tips4:
      "Before using the [DNSPod/ Ali Cloud DNS] API, you need to set the API key of the corresponding interface in the pop-up window",
    ...
    dns_resolve_tips1:
      "It takes a while to resolve the domain, so after all resolution operations completed, please wait at least 3 minutes before clicking the Verify button",
    dns_resolve_tips2:
      "Domain resolution can be manually verified by the CMD command: nslookup-q=txt _ acme-challenge.bt.cn",
    dns_resolve_tips3:
      "If you are using the aaPanel Cloud Resolution plugin, Ali Cloud DNS,DNSPod as a DNS, you can set auto-resolution with the DNS API",
    dns_resolve_tips4:
      "It takes a while to resolve the domain, so after all resolution operations completed, please wait a minute before clicking the Verify button",
    ssl_dir: "Certificate holder",
    brand: "Brand",
    force_https: "Force HTTPS",
    close_force_https_tips:
      "You need to clear the browser cache to see the effect after turning off forced HTTPS. Continue?",
    close_force_https: "Turn off forced HTTPS",
    redirect_tips1:
      "Type: The domain name selected or the path entered will be redirected to the specified URL",
    redirect_tips2:
      "Target URL: Fill in the URL address you need to redirect to",
    redirect_tips3:
      "Mode: use 301 for permanent redirection and 302 for temporary redirection",
    redirect_tips4:
      "Keep URI parameters: Whether the redirected URL has the sub-path or parameters of the source URL",
    redirect_tips5:
      "Keep URI parameters: http://b.com/1.html ---> http://a.com/1.html",
    redirect_tips6:
      "NOT Keep URI parameters: http://b.com/1.html ---> http://a.com",
    ...
    load_conf:
      "Here is the configuration file for the load balancer. If you do not know the configuration rules, do not modify it at will",
    proxy_tips1:
      "Proxy dir: When accessing this dir, the content of the target URL will be displayed (Advanced Needs)",
    proxy_tips2:
      "Target URL:Fill in the website you need to proxy, the target URL must be an accessible URL",
    proxy_tips3:
      "Sent Domain: Add the domain name to the request header and pass it to the proxy server",
    proxy_tips4:
      "Content replacement: Nginx exclusive, replace the content of the website with the specified content",
    ...
    access_empty_ref_default:
      "By default, resources are allowed to be accessed directly,<br>&nbsp; &nbsp; &nbsp; i.e, requests with empty HTTP_REFERER are not restricted.",
    multi_url:
      "Multiple URL suffixes and domains should be separated by comma (,), such as png,jpeg,zip,js",
    trigger_return_404:
      "When hotlink protection is triggered, the 404 status is returned directly",
    redirect: "Redirect",
    ...
    php_cli_tips1:
      "Here you can set the version of PHP when use PHP Command Line Interface",
    php_cli_tips2:
      "This needs to be reset after installing a new version of PHP",
    set_php_cli_cmd: "Set the PHP-CLI (command line) version",
    deploy_success_cret: "Remind: ",
    try_renew_cret:
      "The SSL will be auto renewed 1 month before the expiration date",
    cert_brand: "Brand: ",
    expire_time: "Expire: ",
    auth_domain: "Certified domain(s): ",
    ssl_renew: "Renew",
    deploy_success_tips:
      "<b>Successfully deployed: </b>Please replace the new certificate before the certificate expires",
    not_deploy_and_save:
      '<b style="color:red;">Currently not deployed: </b> Click the [Save] button to complete the deployment of this certificate',
    ...
    batch_input_tips:
      "Click edit content, press enter or lose focus to save automatically",
    ...
    add_site: {
      ...
      bath_tips2:
        "<span style='padding-top:5px;display:inline-block;'>Domain format: domains use &nbsp;,&nbsp; spilt</span>",
      bath_tips3:
        "Document Root: Input&nbsp;1&nbsp;is automatic creation, or enter a specific directory",
      bath_tips4:
        "FTP format: Input&nbsp;1&nbsp;is automatic creation, input&nbsp;0&nbsp;is not creat",
      bath_tips5:
        "Database format: Input&nbsp;1&nbsp;is automatic creation, input&nbsp;0&nbsp;is not creat",
      bath_tips6:
        "PHP version: Input&nbsp;0&nbsp;is static, or input the specific version of PHP, eq,56、71、74",
      bath_tips7:
        "<span style='padding-bottom:5px;display:inline-block;'>A domain per line</span>",
  ...
  public: {
    ...
    scan: "Scanning",
    task_long_time_not_exec:
      "If the task has not been executed for a long time, try to reset the task queue at the home page [restart panel]",
    ...
    can_not_switch_lan:
      "Switching language mode is not supported at this time, so stay tuned!",
    ...
    confirm_restore_file1:
      "After restoring the history file, the current file content will be replaced!",
    ...
    save_tips: "Save Tips",
    save_tips1:
      "Detected that the file was not saved, did you save the file change?",
  ...
  public_backup: {
    ...
    scan_qr_core:
      "Use aaPanel Mobile to scan the current QR code and bind to the panel",
    ...
    tips: "Tips",
    stop_crontab:
      "The cron job will not continue to run after it is paused. Do you really want to deactivate this scheduled task?",
    start_crontab:
      "The cron job has been deactivated. Do you want to enable this cron job?",
    ...
    year3: "3 years",
    permanent: "Permanent",
    buy_multiplev_bt_pro:
      "Note: If you need to purchase multiple permanent licenses, please visit the aaPanel official site to purchase",
    ...
    pro_expire_must_renew_or_change_free_version:
      "(When The Pro version expires, you will need to renew it before you can log in, or you can use SSH to execute the free version downgrade command to switch to the free version)",
    duration: "Duration",
    total: "Total",
    rmb: "Yuan",
    ...
    update_tips:
      "It is recommended that you update the software when the server load is low.",
    db_update_tips:
      "Updating the database is risky and it is recommended to back up your database before updating.",
    update_tips1:
      "If you are using a cloud server, it is highly recommended to take a snapshot before updating.",
    update_tips2:
      "The update process may cause the service to be interrupted. Do you really update [{1}] to [{2}.{3}] now?",
    ...
    sure_del_cert:
      "Are you sure to delete the certificate from the certificate holder?",
    stop_site: "Stop site",
  ...
  install: {
    ...
    passwd_not_same:
      "The passwords entered twice are inconsistent, please re-enter!",
  ...
  tomcat2: {
    ...
    project_tips2:
      "Project mapping can be accessed directly through the domain",
    project_tips3:
      "The default ports for tomcat7, 8, and 9 are 8081, 8082, and 8083",
    ...
    project_tips7:
      "Project version: If you need to add another version of Tomcat service, please install in",
    project_tips8: "",
    confirm: "OK",
    cancel: "Cancel",
    ...
    edit: "Edit",
    del: "Del",
    default_project_subdir_err:
      "Default project does NOT support subdirectory addition",
  ...
  pythonmamager: {
    ...
    operate: "Operate",
    py_tips1:
      "By default, the manager uses the pip to install the module in requirements.txt in the Document Root. If there are other modules to be installed, please manually enter the virtual environment to install",
    ...
    install_py_tips:
      "Installing the python version may take a long time, please be patient",
    ...
    add_py_tips1:
      "Project version: If you need to add another version of Python, please install in",
    ...
    whether_restart_python_project:
      "Are you sure to restart the Python project",
    whether_cancel_python_project:
      "Are you sure to cancel the project mapping domain",
    ...
    add: "Add to",
    add_module_tips:
      "*&nbsp;If the module version is left blank, the latest version will be installed&nbsp;*",
    version: "Version",
    warn: "Warning",
    get_project_module_now: "Getting project [{1}] module, please wait...",
    set_project_module_now: "Setting project [{1}] module, please wait...",
    install_dependent:
      "Installing dependencies required by the project, please wait...",
    being: "",
  ...
  pgsql: {
    ...
    pgsql_tips1:
      "Installing the PgSQL version may take a long time, please be patient",
    pgsql_tips2:
      "To switch versions, first uninstall the current version and manually back up the current database file",
    pgsql_tips3:
      "Here is the pgsql main configuration file. If you don't know the configuration rules, don't modify them at will",
    pgsql_tips4:
      "This profile can be configured to allow which users to connect to which database, which IPs or which network segments are allowed to connect to the server, and the authentication mode used to specify the connection!",
    pgsql_tips5:
      "Here is the pgsql client authentication configuration file. If you don't know the configuration rules, don't modify them at will",
    ...
    whether_res_db_file:
      "Are you sure to restore&nbsp;[{1}]&nbsp;back up files?",
    download_back_file: "Downloading backup file, please wait...",
    whether_del_db_file:
      "Are you sure to delete the &nbsp;[{1}]&nbsp;backup file?",
    import_back_file: "Database [{1}], local file import backup",
    upload_from_local: "Upload from local",
    whether_del_import_file:
      "Are you sure to delete the &nbsp;[{1}]&nbsp;impoerted file?",
    ...
    change_ver_tips:
      "Switch the version, please switch the version, please uninstall the current version first, and manually back up the current database file",
    whether_install_db_ver:
      "Do you want to install the [{1}] data, please select the installed database repository?",
    ...
    get_db_storage_dir:
      "Getting the database storage directory, please wait...",
    ...
    get_db_performance:
      "Getting database performance configuration, please wait...",
  ...
  webhook: {
    ...
    use_tips3:
      "@param param string custom parameters (Use $1 to receive in a hook script)",
    get: "Retrieving...",
  ...
  linuxsys: {
    ...
    save: "Save",
    dns_tips1:
      "If the DNS is set incorrectly, your server will not be able to resolve the domain name, ie you will not be able to access the domain name through the server!",
    dns_tips2:
      "Please click the test button before saving to test if the DNS you set is valid!",
    ...
    confirm: "Confirm",
    swap_tips1:
      "Swap is virtual RAM under Linux, set the appropriate swap to increase server stability",
    swap_tips2:
      "It is recommended that the swap capacity be about 1.5 times the real memory capacity. If your server memory is larger than 4GB, you can set a fixed value of 1-2GB",
    swap_tips3:
      "The swap file is saved by default in /www/swap. Make sure the disk space is enough before setting",
    swap_tips4: "If you don't need swap, set the capacity to 0.",
    swap_tips5:
      "This feature is NOT available for OVZ virtual infrastructure machines",
    now: "Current time:",
    time_zone_tips1:
      "If the time zone is set incorrectly, it may cause the server time to be 'inaccurate'!",
    time_zone_tips2:
      "For Beijing time (CST +0800), please select Asia/Shanghai",
    user_name: "Username",
    new_passwd: "New password",
    again_passwd: "Repeat the password",
    edit: "Modify",
    get_sys_user:
      "The program automatically gets the current user of the system",
    ubuntu_input_change_username:
      "Ubuntu please manually enter the username to be modified",
    ipaddr: "IP address",
    netmask: "Subnet mask",
    gateway: "Gateway",
    add: "Add",
    ...
    used: "Used",
    mem_disk_tips1:
      "The ramdisk has a read/write speed that is unmatched by physical disks, but can only be used to save temporary data!",
    mem_disk_tips2:
      "The RAM disk directly mounts part of the physical RAM as a disk. Please arrange the mount capacity according to the current server RAM usage!",
    mem_disk_tips3:
      "After restarting the server or unloading the RAM disk, the data saved in the RAM disk will be cleared!",
    ...
    adding: "Adding...",
    del_netcard_confirm:
      "Are you sure you want to remove [{1}] from the NIC configuration?",
    del_ip: "Delete IP address",
    deleting: "Deleting...",
    umount_mem_disk: "Unmount the RAM disk",
    umount_tips1:
      "After uninstalling the RAM disk, the target mount directory will be cleared.</p>Are you sure you want to uninstall the mount directory [{1}]?",
  ...
  redis: {
    ...
    switch: "switch",
    edit_conf_tips:
      "The configuration takes effect only after manually restarting Redis. If your data needs to be persisted, please perform the save operation first.",
    edit_file_tips:
      "Hint: Ctrl+F to search for keywords, Ctrl+G to find next, Ctrl+S to save, Ctrl+Shift+R to find replacements!",
    save: "save",
    edit_file_tips1:
      "This is the redis master configuration file. If you don't understand the configuration rules, don't modify it at will.",
    field: "field",
    curr_val: "current value",
    description: "description",
    ...
    redis_status_tips4:
      "The total amount of system RAM currently occupied by Redis",
    ...
    redis_status_tips9:
      "The number of commands executed by the server per second",
    ...
    redis_status_tips13:
      "The number of microseconds spent on the last fork() operation",
  ...
  mongodb: {
    ...
    mongo_conf_file_tips1:
      "Hint: Ctrl+F search keyword, Ctrl+G find next, Ctrl+S save, Ctrl+Shift+R find replace!",
    mongo_conf_file_tips2:
      "This is the MongoDB master configuration file. If you don't understand the configuration rules, don't modify it at will.",
  ...
  one_click: {
    ...
    php_ver: "PHP Version",
    choose_php:
      "Choose the php version supported by the source program please.",
  ...
  mail_sys: {
    ...
    operating: "Operating",
    add_domain_tips:
      "After adding a domain name, you need to add MX records (for mailbox services) and TXT records (for mailbox anti-spam services) in order to use the mailbox service normally.",
    add_domain_tips1:
      "Tip: Some cloud vendors will shut down port 25 by default. You need to contact the manufacturer to open port 25 to use the post office service</font></li>\n" +
    ...
    domain_record_err:
      "The current domain name is not set or is not yet valid or more than one record is recorded.",
    ...
    status: "Status",
    add_user_tips:
      "Note: The current mail server supports IMAP/POP3/SMTP/HTTP protocol.",
    add_user_tips1:
      "POP service [ ServerAddress：<b>{1}</b> Port：<b>110/995</b> ]",
    add_user_tips2:
      "IMAP service [ ServerAddress：<b>{1}</b> Port：<b>143/993</b> ]",
    add_user_tips3:
      "SMTP service [ ServerAddress：<b>{1}</b> Port：<b>25/465/587</b> ]",
    confirm_del_user: "Whether to delete the [{1}] member",
    del_member: "Delete member",
    check_mail_server:
      "Checking if the post office service is working, please wait...",
    not_install_mail_server:
      "Have not installed the mail server before, please feel free to install",
    ...
    mail_domain_tips1:
      "Mail server domain name needs to add A record to post office server IP",
    ...
    mail_server_domain_empty_err:
      "The mail server domain name cannot be empty!",
    ...
    record_tips2:
      "Login to the domain name service provider and add a record with the record type MX for the mailbox service (please copy the following parameters directly)",
    record_type: "Record type",
    mx_priority: "MX priority",
    copy: "Copy",
    record_tips3: "Step 2: Add TXT record",
    record_tips4:
      "Add records with record type TXT for mailbox anti-spam (please copy the following parameters directly)",
    ...
    manager_phone_number_err:
      "Manage phone number format error, please try again",
    ...
    verify_domain_record:
      "Verifying domain name MX records and TXT records, please wait....",
