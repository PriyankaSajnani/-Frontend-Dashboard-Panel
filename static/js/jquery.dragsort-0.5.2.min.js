    ...
    this.each(function (t, o) {
      ...
      var u = {
        ...
        styleDragHandlers: function (t) {
          this.getItems()
            .map(function () {
              return e(this).is(n.dragSelector)
                ? this
                : e(this).find(n.dragSelector).get();
            })
        ...
        grabItem: function (t) {
          ...
          var s = e(t.target)
            .closest("[data-listidx] > " + n.tagName)
            .get(0);
          var o =
            i
              .getItems()
          ...
          if (
            t.which != 1 ||
            e(t.target).is(n.dragSelectorExclude) ||
            e(t.target).closest(n.dragSelectorExclude).size() > 0 ||
            !o
          )
            return;
          t.preventDefault();
        ...
        dragStart: function (t) {
          ...
          i.draggedItem.attr(
            "data-origpos",
            e(this).attr("data-listidx") +
              "-" +
              e(i.container).children().index(i.draggedItem)
          );
          ...
          if (!n.dragBetween) {
            var u =
              e(i.container).outerHeight() == 0
                ? Math.max(
                    1,
                    Math.round(
                      0.5 +
                        (i.getItems().size() * i.draggedItem.outerWidth()) /
                          e(i.container).outerWidth()
                    )
            ...
            i.offsetLimit.bottom =
              i.offsetLimit.top + u - i.draggedItem.outerHeight();
          }
          ...
          i.scroll.scrollY = window.setInterval(function () {
            if (n.scrollContainer != window) {
              e(n.scrollContainer).scrollTop(
                e(n.scrollContainer).scrollTop() + i.scroll.moveY
              );
              return;
            }
            var t = e(n.scrollContainer).scrollTop();
            if (
              (i.scroll.moveY > 0 && t < i.scroll.maxY) ||
              (i.scroll.moveY < 0 && t > 0)
            ) {
          ...
          i.scroll.scrollX = window.setInterval(function () {
            if (n.scrollContainer != window) {
              e(n.scrollContainer).scrollLeft(
                e(n.scrollContainer).scrollLeft() + i.scroll.moveX
              );
              return;
            }
            var t = e(n.scrollContainer).scrollLeft();
            if (
              (i.scroll.moveX > 0 && t < i.scroll.maxX) ||
              (i.scroll.moveX < 0 && t > 0)
            ) {
        ...
        setPos: function (t, r) {
          ...
          if (!n.dragBetween) {
            s = Math.min(
              ...
              Math.max(s, this.offsetLimit.top)
            );
            o = Math.min(
        ...
        wheel: function (t) {
          if (i && n.scrollContainer != window) {
            ...
            if (
              t.clientX > s.left &&
              t.clientX < s.left + r.width() &&
              t.clientY > s.top &&
              t.clientY < s.top + r.height()
            ) {
        ...
        buildPositionTable: function () {
          var t = [];
          this.getItems()
            .not([i.draggedItem[0], i.placeHolderItem[0]])
            .each(function (n) {
              var r = e(this).offset();
        ...
        dropItem: function () {
          ...
          if (
            i.draggedItem.attr("data-origpos") !=
            e(r).index(i) + "-" + e(i.container).children().index(i.draggedItem)
          )
            if (n.dragEnd.apply(i.draggedItem) == false) {
              var s = i.draggedItem.attr("data-origpos").split("-");
              var o = e(r[s[0]].container)
                .children()
                .not(i.draggedItem)
                .eq(s[1]);
        ...
        swapItems: function (t) {
          ...
          if (
            s == null ||
            s.top > i.draggedItem.offset().top ||
            s.left > i.draggedItem.offset().left
          )
        ...
        createDropTargets: function () {
          ...
          e(r).each(function () {
            ...
            if (t.size() > 0 && r.size() > 0) r.remove();
              ...
              if (n.tagName == "td")
                e(n.placeHolderTemplate)
                  .attr("data-droptarget", true)
                  .appendTo(this.container);
              else
                e(this.container).append(
                  i.placeHolderItem
