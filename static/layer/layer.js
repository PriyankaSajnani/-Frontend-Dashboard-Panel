!(function (e, t) {
          ...
          r.open(
            i.extend(
              ...
              l && !o.config.skin
                ...
                : ((n = n || {}),
                  (-1 === n.icon || (n.icon === t && !o.config.skin)) &&
  ...
  (s.anim = [
    ...
    (l.pt.creat = function () {
      ...
      if (!i("#" + t.id)[0]) {
        switch (
          ...
          case 2:
            (l = t.content =
              f ? t.content : [t.content || "http://layer.layui.com", "auto"]),
              (t.content =
                '<iframe scrolling="' +
                (t.content[1] || "auto") +
    ...
    (l.pt.callback = function () {
      ...
      1 == a.type &&
      "" != a.area[1] &&
      parseInt(a.area[1]) >= window.innerHeight
        ? ($(n.selector).css({ height: window.innerHeight, top: 0 }),
          $(n.selector)
            .find(".bt-w-menu")
            .css({ height: parseInt(a.area[1]) - 42 }),
          $(n.selector)
          ...
          $(n.selector)
            ...
            .css({ height: window.innerHeight - 42, overflowY: "scroll" }))
        : 1 == a.type &&
          "" == a.area[1] &&
          $(n)[0].offsetHeight >= window.innerHeight &&
          $(n).find(".layui-layer-content")[0].offsetHeight <
            $(n).find(".layui-layer-content")[0].scrollHeight &&
          ($(n.selector).css({ height: window.innerHeight, top: 0 }),
          $(n.selector)
            .find(".layui-layer-close")
            .removeClass("layui-layer-close2")
            .addClass("layui-layer-close1")),
        1 == a.type && console.log($(n)[0].offsetHeight, window.innerHeight),
        t.openLayer(),
        a.success &&
          (2 == a.type
